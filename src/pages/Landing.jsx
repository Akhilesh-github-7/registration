    ...
    <>
      ...
      <div className='container mt-4 p-3'>
        <div className='row'>
          ...
          <div style={{ backgroundColor: 'white' }} className="col border shadow rounded">
            <div className='p-1 mb-3' style={{backgroundColor:'green'}}>
              <h3 style={{ width: '700px'}} className='text-center mb-3 fs-1 fw-bold pt-2 text-light'>Higher Secondary Admission Form</h3>
              <h5 className='text-center fw-bold mb-4 text-light'>
              Don Bosco Senior Secondary School, Vaduthala - 682023</h5>
            </div>
            ...
            <div className='p-5'>
              <Form>
                ...
                <div style={{width:"200px"}} className='d-flex mt-5 justify-content-between align-items-center'>
                  <Link to={'/candidatedetails'} onClick={saveFormDetails} className='btn btn-success'  type='submit' >Register</Link>
